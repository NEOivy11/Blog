<%@ page language="java" import="java.util.*" import="com.neo.entity.OpeLog" pageEncoding="UTF-8"%>
<%
    ...
    <div id="big_cont">
       <%@include file="header.jsp" %>
        ...
        <div id="body_cont">
            ...
            <div id="med_cont">
            <h2 style="text-align:center">操作日志</h2>
                ...
                <table id="table1">
					...
					<%List<OpeLog> logList = (List<OpeLog>)request.getAttribute("logList"); %>
					
                    <%for (OpeLog log:logList){                 
					%>
                    <tr>
                        <td><%=log.getLogDate() %></td>
                        <td><%=log.getUserName() %></td>
                        <td><%=log.getChangeUser() %></td>
